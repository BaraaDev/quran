...
@section('contact')
    <div class="page-nav bg-lightblue pt-lg--7 pb-lg--7 pb-5 pt-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center"><h1 class="text-grey-800 fw-700 display3-size">جميع المقالات <span class="font-xsss text-grey-600 fw-600 d-block mt-2"><a href="{{route('home')}}" class="font-xsss text-success fw-600">الرئيسية</a> / المقالات</span></h1></div>
            </div>
        </div>
    </div>
