    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center pt-lg--10 pt-7">
                ...
                <a href="javascript:void()" class="btn border-0 bg-dark text-uppercase p-3 text-white fw-700 ls-3 rounded-lg d-inline-block font-xssss btn-light mt-3 w200 aos-init" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">إبدا الان معنا</a>
            </div>
            <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 @if($loop->first) @else order-lg-1 pt-lg--5 offset-lg-1 @endif">
                ...
                <a href="javascript:void()" class="btn border-0 bg-primary p-3 text-white fw-600 rounded-lg d-inline-block font-xssss btn-light mt-3 w150 aos-init" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">Subscribe</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                    <article class="post-article p-0 border-0 shadow-xss rounded-lg overflow-hidden">
                        ...
                        <div class="post-content p-4">
                            ...
                            <h2 class="post-title mt-2 mb-2 pl-3"><a href="javascript:void()" class="lh-30 font-sm cairo-font text-grey-800 fw-700">{{$article->title}}</a></h2>
