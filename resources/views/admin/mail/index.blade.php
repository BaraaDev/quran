...
@section('title')
    @if($request->keyword) {{Request::old('keyword') ? Request::old('keyword') : $request->keyword}} -  @else صندوق الوارد -  @endif
@endsection
@section('head1')
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">صندوق بريد</span> - الصفحة الرئيسية</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    @if($request->keyword)
                        <a href="{{route('mail.index')}}" class="breadcrumb-item"> صندوق الوارد</a>
                    @endif
                    <span class="breadcrumb-item active">@if($request->keyword){{Request::old('keyword') ? Request::old('keyword') : $request->keyword}} @else صندوق الوارد @endif</span>
                </div>
             </div>
        </div>
    </div> <!-- /page header -->
        ...
        <div class="card">
            ...
            <div class="card-header bg-transparent header-elements-inline">
                ...
                <div class="header-elements">
                    ...
                    @else
                        <span class="badge bg-blue">{{$contactUsCount}} جديد لم تُقرأ بعد</span>
                    @endif
