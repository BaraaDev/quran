...
@section('title')
    @if($request->keyword) {{Request::old('keyword') ? Request::old('keyword') : $request->keyword}} -  @else صندوق الإرسال -  @endif
@endsection
@section('head1')
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item">
                            <a href="{{route('mail.sender')}}" class="nav-link active"><i class="icon-drawer-out"></i>البريد المرسل</a>
                        </li>
                        <li class="nav-item">
...
@endsection
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">صندوق الإرسال</span> - الصفحة الرئيسية</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    @if($request->keyword)
                        <a href="{{route('mail.sender')}}" class="breadcrumb-item"> صندوق الإرسال</a>
                    @endif
                    <span class="breadcrumb-item active">@if($request->keyword){{Request::old('keyword') ? Request::old('keyword') : $request->keyword}} @else صندوق الإرسال @endif</span>
                </div>
             </div>
        </div>
    </div> <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-header bg-transparent header-elements-inline">
                <h6 class="card-title">صندوق الإرسال الخاص بي</h6>
            </div>
