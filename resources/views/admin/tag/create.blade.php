...
@section('title')إضافة علامات جديد -@endsection
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">لوحة التحكم</span> - إضافة علامات جديد</h4>
                <a href="javascript:void(0);" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>

            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{route('tags.create')}}" class="btn btn-link btn-float text-default"><i class="icon-plus22 text-green"></i><span>إضافة علامات جديد</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('tags.index')}}" class="breadcrumb-item"> العلامات</a>
                    <span class="breadcrumb-item active">إضافة علامات جديد</span>
                </div>
            </div>
        </div>
    </div><!-- /page header -->
