        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{route('users.create')}}" class="btn btn-link btn-float text-default"><i class="icon-plus22 text-green"></i><span>إنشاء مستوي جديد</span></a>
                </div>
            </div>
        </div>
    ...
    @include('admin.layouts.partials.validation-errors')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('users.update',$model->id)}}" method="post" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <fieldset class="mb-3">
