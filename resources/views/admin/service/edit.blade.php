        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{route('services.index')}}" class="breadcrumb-item"> الخدمات</a>
    ...
    @include('admin.layouts.partials.validation-errors')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('services.update',$model->id)}}" method="post" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <fieldset class="mb-3">
