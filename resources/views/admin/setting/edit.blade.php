...
@section('title')تعديل الإعدادات -@endsection
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">لوحة التحكم</span> - تعديل الإعدادات</h4>
            </div>
        </div>
    ...
    @include('admin.layouts.partials.validation-errors')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('settings.update',$model->id)}}" method="post" files="true" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <fieldset class="mb-3">
