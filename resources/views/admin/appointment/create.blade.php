...
@inject('model','App\Models\Appointment')
@section('title')إضافة مواعيد جديده -@endsection
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">لوحة التحكم</span> - إضافة مواعيد جديده</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">إضافة مواعيد جديده</span>
                </div>
            </div>
        </div>
    </div><!-- /page header -->
