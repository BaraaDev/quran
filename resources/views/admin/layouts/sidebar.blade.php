...
<div class="sidebar-content">
    ...
    <div class="card card-sidebar-mobile">
        <ul class="nav nav-sidebar" data-nav-type="accordion">
            ...
            <!-- Main -->
            <li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">قائمة التنقل والأعدادات</div> <i class="icon-menu" title="قائمة التنقل والأعدادات"></i></li>
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('levels.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('articles.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('categories.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('tags.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('appointments.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('events.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('services.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('testimonials.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('users.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('mail.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">قائمة الأعدادات</div> <i class="icon-menu" title="قائمة الأعدادات"></i></li>


            <li class="nav-item nav-item-submenu @if(active()->route('about_us.*')) nav-item-expanded nav-item-open @else  @endif">
            ...
            <li class="nav-item nav-item-submenu @if(active()->route('settings.*')) nav-item-expanded nav-item-open @else  @endif">
