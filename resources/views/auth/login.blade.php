            ...
            <div class="card shadow-none border-0 ml-auto mr-auto login-card">
                <div class="card-body rounded-0 text-left">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group icon-input mb-3">
                            <input name="password" type="password" class="style2-input pl-5 form-control text-grey-900 font-xss ls-3 @error('password') is-invalid @enderror" value="{{ old('password') }}" autocomplete="current-password" placeholder="كلمة السر">
                        ...
                        <div class="col-sm-12 p-0 text-left">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32 text-center">ليس لديك حساب <a href="{{route('register')}}" class="fw-700 ml-1">سجل </a></h6>
                        </div>
                    </form>
                </div>
            </div>
